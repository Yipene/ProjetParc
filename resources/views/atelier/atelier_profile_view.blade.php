                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <div>
                                <img class="wd-70 rounded-circle"
                                    src=" {{ !empty($profileData->photo) ? url('upload/atelier_images/' . $profileData->photo) : url('upload/no_image.jpeg') }}"
                                    alt="profile">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title">Profile Du Technicien de L'atelier de amintenance</h6>

                            <form class="forms-sample" method="POST" action=" {{route('atelier.profile.store')}} " enctype="multipart/form-data">
